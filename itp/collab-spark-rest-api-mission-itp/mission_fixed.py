...
def create_team(team_name):
    ...
    apiUrl = "https://api.ciscospark.com/v1/teams" # MISSION: Provide the resource URL for creating Teams
    body = {"name": team_name}
...
def create_room(room_name, team_id):
    ...
    body = {"title": room_name, "teamId": team_id} # MISSION: Key responsible for team ID is missing
